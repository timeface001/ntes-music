...
import com.fs.dreams.config.exception.NtesServiceExption;
import com.fs.dreams.exchange.dto.AjaxResult;
...
public class ExceptionHandlerController {
    ...
    @ExceptionHandler(NtesServiceExption.class)
    public AjaxResult handleServiceException(NtesServiceExption e) {
    ...
    public AjaxResult handleException(IbatisException e) {
        logger.error("IBatis异常", e);
        return new AjaxResult().failure("IBatis异常：" + e.getMessage());
    }
